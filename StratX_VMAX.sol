...
contract StratX is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isAutoComp; // this vault is purely for staking. eg. WBNB-VMAX staking vault.
    ...
    address[] public earnedToVMAXPath;
    ...
    constructor(
        ...
        vmaxFarmAddress = _vmaxFarmAddress;
        ...
        if (isAutoComp) {
            ...
            earnedToVMAXPath = [earnedAddress, wbnbAddress, VMAXAddress];
            if (wbnbAddress == earnedAddress) {
                earnedToVMAXPath = [wbnbAddress, VMAXAddress];
            }
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(vmaxFarmAddress, _wantAmt);
